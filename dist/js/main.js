...
const getGeoWeather = (event) => {
        if (event && event.type === "click") {
            ...
            addSpinner(mapIcon);            //add spinner
        }
    
    if (!navigator.geolocation) return geoError(); //if we dont get a geo location, then call the geo error call back otherwise
...
const geoSuccess = (position) => {
    const myCoordsObj = {
        ...
        name: `Lat:${position.coords.latitude} Long:${position.
            coords.longitude}`
    };
    //set location object
